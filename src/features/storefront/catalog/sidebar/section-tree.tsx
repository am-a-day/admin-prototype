...
import { Asterisk, CaretDoubleLeft, CaretDown, CaretRight, Check, DotsThreeVertical, LockLaminated, MagnifyingGlass, Plus, X } from "@phosphor-icons/react";
...
const CATALOG_SECTION_HEADER_ACTIONS_CLASS = "flex w-[46px] shrink-0 items-center gap-1.5";
...
export function UnifiedCatalogTreePanel({
          ...
          <>
            ...
            >
              <div
                ...
                className="flex min-w-0 flex-1 items-center pr-[52px]"
                ...
                <>
                  {(availabilityStatus || showEmptyIndicator) && (
                    <span
                      ...
                      className={cn(
                        "pointer-events-none absolute right-0.5 top-1.5 z-[5] flex size-5 items-center justify-center group-hover:opacity-0",
                  ...
                  >
                    <span
                      data-catalog-section-add-action
                      className={cn(
                        "pointer-events-none absolute right-7 top-1.5 z-10 flex size-5 items-center justify-center opacity-0 group-hover:pointer-events-auto focus-within:pointer-events-auto focus-within:opacity-100",
                        isArchived ? "group-hover:opacity-60" : "group-hover:opacity-100",
                      )}
                    ...
                    >
                      <Button
                        ...
                        className="size-5 rounded-[6px] text-[#78716c] hover:bg-[#e7e5e4] hover:text-[#292524] focus-visible:bg-[#e7e5e4] focus-visible:ring-[#292524]/10 disabled:cursor-not-allowed disabled:text-[#d6d3d1]"
                      >
                  ...
                  >
                    <DropdownMenuTrigger asChild>
                      <Button
                        ...
                        size="icon"
                        data-no-dnd
                        data-catalog-section-more-action
                        aria-label={`Действия с разделом ${section.name}`}
                        onClick={(event) => event.stopPropagation()}
                        className={cn(
                          "pointer-events-none absolute right-0.5 top-1.5 z-10 size-5 shrink-0 rounded-[6px] text-[#78716c] opacity-0 group-hover:pointer-events-auto hover:bg-[#e7e5e4] hover:text-[#292524] focus-visible:pointer-events-auto focus-visible:bg-[#e7e5e4] focus-visible:opacity-100 focus-visible:ring-[#292524]/10",
                          isArchived ? "group-hover:opacity-60" : "group-hover:opacity-100",
                        )}
                      >
  ...
  const sectionsHeader = (
    <div className="flex h-6 shrink-0 items-center justify-between pl-2 pr-0.5">
      ...
      <div data-catalog-section-action-grid="header" className={CATALOG_SECTION_HEADER_ACTIONS_CLASS}>
  ...
  return (
    <aside className="relative flex h-full w-full min-w-0 flex-col overflow-hidden bg-white shadow-[inset_-1px_0_0_#e7e5e4]">
      ...
      <div className="mt-2 flex min-h-0 flex-1 flex-col gap-2">
        <div data-catalog-tree-primary-navigation className="shrink-0 border-b border-[#e7e5e4] pb-3 pl-2 pr-1.5">
          <button
            type="button"
            ...
            className={cn(
              ...
              allPositionsSelected && !stopListActive ? "bg-[#f5f5f4]" : "hover:bg-[#f5f5f4]",
            )}
          >
            <span className="flex size-5 shrink-0 items-center justify-center rounded-[4.615px] border-[0.714px] border-[#e7e5e4] bg-white text-[#57534d]">
              <Asterisk size={14} weight="regular" aria-hidden="true" />
            </span>
            <span className={cn(
              "min-w-0 flex-1 truncate text-[13px] font-medium leading-4",
              allPositionsSelected && !stopListActive ? "text-[#292524]" : "text-[#79716b]",
            )}>
              Все позиции
            </span>
          ...
          <button
            type="button"
            data-catalog-stop-list-entry
            aria-current={stopListActive ? "page" : undefined}
            onClick={onSelectStopList}
            className={cn(
              "flex h-8 w-full items-center gap-2 rounded-[8px] p-1.5 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#292524]/10",
              stopListActive ? "bg-[#f5f5f4]" : "hover:bg-[#f5f5f4]",
            )}
          >
            <span className="flex size-5 shrink-0 items-center justify-center rounded-[4.615px] border-[0.714px] border-[#e7e5e4] bg-white text-[#57534d]">
            ...
            <span className={cn(
              "min-w-0 flex-1 truncate text-[13px] font-medium leading-4",
              stopListActive ? "text-[#292524]" : "text-[#79716b]",
            )}>
              Стоп-лист
            </span>
            <span className="shrink-0 text-right text-[11px] leading-[18px] tabular-nums text-[#78716c]">{stopListCount}</span>
          </button>
        </div>
